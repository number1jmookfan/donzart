...
export default function Settings({ timeline, selectedCell }: { timeline: any[][], selectedCell: { row: number; col: number } }) {
    ...
    return (
        <div className="w-full flex-col grid grid-cols-6 gap-4 justify-between text-center">
            <div className="border-r-3 p-4">
                <label htmlFor="volume" className="block mb-2 dark:text-white">Volume</label>
                <input id="volume" type="range" defaultValue={cellContext.gainNode?.gain.defaultValue} min={cellContext.gainNode?.gain.minValue} max={cellContext.gainNode?.gain.maxValue} onChange={(e) => { setVolume(Number((e.target as HTMLInputElement).value), cellContext.gainNode); console.log("Volume changed:", cellContext.gainNode); }} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
            </div>
            ...
            <div className="border-r-3 p-4">
                <label htmlFor="delay" className="block mb-2 dark:text-white">Delay</label>
            ...
            <div className="border-r-3 p-4">
                <label htmlFor="filter" className="block mb-2 dark:text-white">Filter</label>
            ...
            <div className="border-r-3 p-4">
                <label htmlFor="pan" className="block mb-2 dark:text-white">Pan</label>
            ...
            <div className="border-r-3 p-4">
                <label htmlFor="pitch" className="block mb-2 dark:text-white">Pitch</label>
            ...
            <div className="p-4">
                <label htmlFor="speed" className="block mb-2 dark:text-white">Speed</label>
